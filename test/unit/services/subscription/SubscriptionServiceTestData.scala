...
trait SubscriptionServiceTestData {
  ...
  val address: Address = Address("Line 1", Some("line 2"), Some("city name"), Some(""), Some("SW1A 2BQ"), "GB")
  ...
  val fullyPopulatedSubscriptionDetails = SubscriptionDetails(
    ukVatDetails = Some(VatDetails("SW1A 2BQ", "123456789", LocalDate.parse("2017-01-01"))),
    ...
    addressDetails = Some(AddressViewModel("Line 1 line 2", "city name", Some("SW1A 2BQ"), "GB"))
  )
  ...
  def existingRegistrationSubcriptionRequestJson(contactEmail: String): JsValue =
    Json.parse(s"""{
         ...
         |      "contactInformation":{"personOfContact":"Name","sepCorrAddrIndicator":true,"streetAndNumber":"Street","city":"city","postalCode":"SW1A 2BQ","countryCode":"GB","telephoneNumber":"00088000000","faxNumber":"00088000000","emailAddress":"$contactEmail", "emailVerificationTimestamp": "$emailVerificationTimestamp"},
         |      "vatIDs": [
         |        {
         |          "countryCode": "AD",
         |          "vatID": "4567"
