...
class RegistrationDetailsServiceSpec extends UnitSpec with MockitoSugar with BeforeAndAfterEach {
  ...
  private val updatedAddress = Address("Line 1", Some("line 2"), Some("line 3"), Some("line 4"), Some("SW1A 2BQ"), "GB")
  ...
  private val registrationDetailsService = new RegistrationDetailsService(mockSessionCache)
