...
class ConfirmIndividualTypeControllerSpec extends ControllerSpec with BeforeAndAfter {
  ...
  private val ErrorSelectSoleTraderOrIndividualFieldError = "Error:Select sole trader or individual"
  ...
  "Radio button selection" should {
    ...
    "be mandatory" in submitForm(validRequestData - "individual-type") { result =>
      ...
      page.getElementsText(fieldLevelErrorIndividualTypeXPath) shouldBe ErrorSelectSoleTraderOrIndividualFieldError
