...
import uk.gov.hmrc.customs.rosmfrontend.views.html.subscription.subscription_create_subscription_in_progress
import util.ViewSpec

class SubscriptionCreateSubscriptionInProgressSpec extends ViewSpec {
  ...
  private val view = app.injector.instanceOf[subscription_create_subscription_in_progress]
