...
import uk.gov.hmrc.customs.rosmfrontend.views.html.subscription.subscription_create_eori_already_associated
import util.ViewSpec

class SubscriptionCreateEoriAlreadyAssociatedSpec extends ViewSpec {
  ...
  private val view = app.injector.instanceOf[subscription_create_eori_already_associated]
