...
object SubscriptionDateOfBirthPage extends SubscriptionDateCommon {
  ...
  override val url: String = Env.frontendHost + "/customs/register-for-cds/date-of-birth"
...
object SubscriptionDateOfEstablishmentPage extends SubscriptionDateCommon {
  ...
  override val url: String = Env.frontendHost + "/customs/register-for-cds/date-established"
