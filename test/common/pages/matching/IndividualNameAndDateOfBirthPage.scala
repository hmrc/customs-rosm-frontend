...
object IndividualNameAndDateOfBirthXPath extends IndividualNameAndDateOfBirthXPath
...
abstract class IndividualNameAndDateOfBirthPage(val organisationType: String)
  ...
  override val url: String = Env.frontendHost + s"/customs/register-for-cds/matching/row-name-date-of-birth/$organisationType"
