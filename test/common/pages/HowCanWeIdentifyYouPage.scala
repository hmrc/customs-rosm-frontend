...
object SubscribeHowCanWeIdentifyYouPage extends HowCanWeIdentifyYouPage {
  override val url: String = Env.frontendHost + "/customs/subscribe-for-cds/chooseid"
}

object RegisterHowCanWeIdentifyYouPage extends HowCanWeIdentifyYouPage {
  override val url: String = Env.frontendHost + "/customs/register-for-cds/matching/chooseid"
}
