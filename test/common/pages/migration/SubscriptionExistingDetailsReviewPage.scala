...
class SubscriptionExistingDetailsReviewPage extends WebPage {
  ...
  val UKVatIdentificationNumbersXpathLabel = "//dt[@id='review-tbl__gb-vat_number_heading']"
  val UKVatIdentificationNumbersXpath = "//dd[@id='review-tbl__gb-vat_number']"

  val UKVatIdentificationPostcodeXpathLabel = "//dt[@id='review-tbl__gb-vat_postcode_heading']"
  val UKVatIdentificationPostcodeXpath = "//dd[@id='review-tbl__gb-vat_postcode']"

  val UKVatIdentificationDateXpathLabel = "//dt[@id='review-tbl__gb-vat_date_heading']"
  ...
  val EUDisclosureConsentXPath = "//div[@id='review-tbl__disclosure']/dd[1]"
  ...
  val UtrNoLabelXPath = "//[@id='review-tbl__utr_heading']"
  val UtrNoLabelValueXPath = "//[@id='review-tbl__utr']"

  val DateOfEstablishmentLabelXPath = "//div[@id='review-tbl__doe']/dt"
  val DateOfEstablishmentXPath = "//div[@id='review-tbl__doe']/dd[1]"
  val DateOfEstablishmentReviewLinkXPath = "//div[@id='review-tbl__doe']/dd[2]/a"

  val LimitedAddressLabelXpath = "//[@id='review-tbl__address_heading']"
