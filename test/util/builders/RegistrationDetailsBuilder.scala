...
object RegistrationDetailsBuilder {
  ...
  val defaultAddress: Address =
    Address("Line 1", Some("line 2"), Some("line 3"), Some("line 4"), Some("SW1A 2BQ"), "GB")
  ...
  val individualRegistrationDetailsNotIdentifiedByRegisterWithID = DefaultIndividualRegistrationDetails.copy(safeId = SafeId(""))
  ...
  val subscriptionStatusOutcome: SubscriptionStatusOutcome = SubscriptionStatusOutcome("2016-08-18T14:01:05")
