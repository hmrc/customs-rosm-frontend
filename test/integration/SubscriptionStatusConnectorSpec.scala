...
import uk.gov.hmrc.customs.rosmfrontend.domain.{SubscriptionStatusQueryParams, SubscriptionStatusResponseHolder, TaxPayerId}
  ...
  override implicit lazy val app: Application = new GuiceApplicationBuilder()
    .configure(
      Map(
        ...
        "microservice.services.customs-hods-proxy.subscription-status.context" -> "subscription-status",
