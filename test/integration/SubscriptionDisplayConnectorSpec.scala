...
class SubscriptionDisplayConnectorSpec extends IntegrationTestsSpec with ScalaFutures {
  ...
  override implicit lazy val app: Application = new GuiceApplicationBuilder()
    .configure(
      Map(
        ...
        "microservice.services.customs-hods-proxy.subscription-display.context" -> "subscription-display",
  ...
  private val requestTaxPayerId = "ABC1DEF23HIJKLM"
