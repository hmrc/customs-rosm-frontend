...
class RegisterWithoutIdConnectorSpec extends IntegrationTestsSpec with ScalaFutures {
  ...
  override implicit lazy val app: Application = new GuiceApplicationBuilder()
    .configure(
      Map(
        ...
        "microservice.services.customs-hods-proxy.register-without-id.context" -> "register-without-id",
  ...
  val organisationReq = RegisterWithoutIDRequest(
    ...
    RegisterWithoutIdReqDetails.organisation(
      ...
      Address("Line 1", Some("line 2"), Some("line 3"), Some("line 4"), Some("SW1A 2BQ"), "ZZ"),
      contactDetails
    )
  )
  ...
  val individualReq = RegisterWithoutIDRequest(
    ...
    RegisterWithoutIdReqDetails.individual(
      address = Address("Line 1", Some("line 2"), Some("line 3"), Some("line 4"), Some("SW1A 2BQ"), "ZZ"),
